using kiniaawiBooks.Areas.Admin.Models;
...
namespace kiniaawiBooks.Areas.Admin.Controllers
{
    ...
    public class RoleController : Controller
    {
        ...
        public async Task<IActionResult> Assign(RoleUserVm roleUser)
        {
            ...
            {
                ViewBag.mgs = "This user already has his role assigned";
                ViewData["UserId"] = new SelectList(_db.ApplicationUsers.Where(f => f.LockoutEnd < DateTime.Now || f.LockoutEnd == null).ToList(), "Id", "UserName");
                ViewData["RoleId"] = new SelectList(_roleManager.Roles.ToList(), "Name", "Name");
                return View();
            }
            ...
            if(role.Succeeded)
            {
                ...
                //"User Role assigned succesfully";
                return RedirectToAction(nameof(Index));
            }
            return View();
        }
        ...
        {
            var result = from ur in _db.UserRoles join r in _db.Roles on ur.RoleId equals r.Id join a in _db.ApplicationUsers on ur.UserId equals a.Id select new UserRoleMapping()
            {
                UserId=ur.UserId,
                RoleId=ur.RoleId,
                UserName=a.UserName,
